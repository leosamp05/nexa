...
export const appConfig = {
  ...
  queueAttempts: parseNumber(process.env.QUEUE_ATTEMPTS, 3),
  queueRetryDelayMs: parseNumber(process.env.QUEUE_RETRY_DELAY_MS, 5000),
  ...
  antivirusEnabled: parseBool(process.env.ANTIVIRUS_ENABLED, false),
